...
<div class="header">
    ...
    <div class="head-top">
        <div class="top-link">
            <p>你好，user <a href="ExitServlet">[退出]</a></p>
        </div>
    </div>
    <!-- top -->
...
<div class="car-bady clearfix">
    ...
    <div class="carTypeList clearfix">
        ...
        <c:forEach var="item" items="${sessionScope.cars}">
            <div class="carlist clearfix">
                <ul>
                    <li>
                        <div class="car-img">
                    ...
                    <li>
                        ...
                        <div class="price-a"><a href="OrderServlet?id=${item.id}">套餐预约</a></div>
                    </li>
                </ul>
            </div>
        </c:forEach>
   ...
   // *共有种车型可以租用
    ...
    function jsonToStr(value) {
        var str ="<div class=\"carlist clearfix\">\n" +
            ...
            "                            <p class=\"info\">"+value.carInfo+"</p>\n" +
            "                        </div>\n" +
            "                    </li>\n" +
            "                    <li>\n" +
            "                        <div class=\"price\">\n" +
            "                            <span class=\"rmb\">￥</span>\n" +
            "                            <span class=\"num\">"+value.rent+"</span>\n" +
            "                            <span class=\"unit\">/套餐价</span>\n" +
            "                        </div>\n" +
            "                        <div class=\"price-a\"><a href=\"OrderServlet?id="+value.id+"\">套餐预约</a></div>\n" +
            "                    </li>\n" +
            "                </ul>\n" +
            "            </div>";
        console.log(str);
